        ...
        <footer className="bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                        <div className="flex items-center mb-4">
                            ...
                            <div className="ml-3">
                                <h3 className="text-xl font-bold">CV Roster</h3>
                                <p className="text-xs text-gray-400">Purwakarta</p>
                            </div>
                        </div>
                        <p className="text-gray-400">
                            Penyedia roster beton berkualitas tinggi di Plered, Purwakarta, Jawa Barat.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400">
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                info@rosterbetonpurwakarta.com
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                    <p>&copy; 2024 CV Roster Purwakarta. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
